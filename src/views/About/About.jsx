        ...
        <div className={styles.squares}>
          <section className={styles.team}>
            ...
            <p>
              ...
              fancy meal he's ever cooked was Backpacker's Pad Thai. His
              favorite cook book is Foodheim by Eric Wareheim.
            </p>
          ...
          <section className={styles.team}>
            ...
            <p>
              ...
              easier place for everyone! His hobbies are boxing, archery,
              playing video games, and his favorite cook book is From Crook to
              Cook by Snoop Dogg.
            </p>
            <div className={styles.links}>
              <a
          ...
          <section className={styles.team}>
            <h3>Trevor Rezac</h3>
            <p>
              Trevor Rezac is a foodie, and a Full Stack Software Developer
              based in Beaverton, OR. His favorite cuisines are Indian,
              Vietnamese, and Mexican. He enjoys trying out new recipes from a
              variety of different recipe books & Gordon Ramsay is his spirit
              animal. Also, Trevor makes a mean guacamole (ask him about the
              secret ingredient)!
            </p>
            <div className={styles.links}>
              <a
          ...
          <section className={styles.team}>
            ...
            <p>
              ...
              before coding. One of her favorite cook books is ‘The Book of
              Jewish Food’ by Claudia Roden because it mostly gets used when
              cooking on special occasions for family and friends.
            </p>
            <div className={styles.links}>
              <a
                className={styles.linkedin}
